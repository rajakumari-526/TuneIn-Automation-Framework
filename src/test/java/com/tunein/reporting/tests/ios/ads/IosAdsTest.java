...
public class IosAdsTest extends AdsTest {
    ...
    public void testInStreamFlowSuccessEvents() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            JsonObject instreamData = getLastUnifiedEventRequestByType(UNIFIED_EVENT_ADS_INSTREAM_STARTED);
        ...
        for (String event : events) {
            ...
            switch (event) {
                ...
                case UNIFIED_EVENT_ADS_INSTREAM_RECEIVED, UNIFIED_EVENT_ADS_INSTREAM_STARTED, UNIFIED_EVENT_ADS_INSTREAM_COMPLETED -> {
                    ...
                    unifiedEventsAsserts.verifyUnifiedEventContextListeningInfo(data, STREAM_STATION_ADSWIZZ_INSTREAM_AD);
                }
    ...
    public void testAdsRequestEvent() {
        ...
        unifiedEventsAsserts.validateThatParameterIsNotPresent(data, UNIFIED_EVENT_JSON_PARAM_IS_COMPANION_AD);
    }
