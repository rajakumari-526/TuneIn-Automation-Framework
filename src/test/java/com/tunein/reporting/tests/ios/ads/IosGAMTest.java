...
import static com.tunein.mobile.reporting.GAMEventConstants.GAM_BUNDLE_ID;
...
public class IosGAMTest extends GAMTest {
    ...
    public void testInstreamGAMHighValueParameters() {
        ...
        String[] adsParams = {GAM_REQUEST_PPID, GAM_REQUEST_CIU_SZS, GAM_REQUEST_RDID, GAM_REQUEST_ID_TYPE,
                GAM_REQUEST_PALN, GAM_REQUEST_DESCRIPTION_URL, GAM_REQUEST_CUST_PARAMS, GAM_REQUEST_URL,
                GAM_REQUEST_BUNDLE_ID, GAM_REQUEST_HL};
